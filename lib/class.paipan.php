...
class paipan{
    ...
    private $qiKB = [ //气直线拟合参数 使农历-720年至2300年与寿星万年历匹配(鉴于800年前的农历太复杂,暂屏蔽800年前的部分)
	...
	private $suoKB = [ //朔直线拟合参数 使农历-720年至2300年与寿星万年历匹配(鉴于800年前的农历太复杂,暂屏蔽800年前的部分)
    ...
    public function GetXZ($yy, $mm, $dd, $hh, $mt = 0, $ss = 0) {
        ...
        //顯示星座,根据公历的中气判断
        $zr = $this->GetZQsinceWinterSolstice($yy, false);
        if ($spcjd < $zr[0]) {
            $zr = $this->GetZQsinceWinterSolstice($yy - 1, false);
        } //若小於雨水，則歸前一年
