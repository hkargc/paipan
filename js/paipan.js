...
function paipan() {
     ...
     * @return false|number
     */
    this.Jdays = function(yy, mm, dd, hh, mt = 0, ss = 0) {
     ...
     * @return number
     */
    this.MeanNewMoonDay = function(jd) {
        var t, thejd, jdt;
        var jd = this.floatval(jd);
     ...
     */
    this.GetGZ = function(yy, mm, dd, hh, mt = 0, ss = 0) {
        var yy = this.floatval(yy);
        var mm = this.floatval(mm);
        var dd = this.floatval(dd);
        var hh = this.floatval(hh);
     ...
     * @return false/array
     */
    this.fatemaps = function(xb, yy, mm, dd, hh, mt = 0, ss = 0) {
